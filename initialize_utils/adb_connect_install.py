...
def adb_connect_install(adb_exe_path, adb_connection_str, apk_path, sleep_time=5) -> bool:
...
def adb_connect_uninstall_pkg(adb_exe_path, adb_connection_str, pkg_name, sleep_time=5) -> bool:
...
def adb_connect_uninstall(adb_exe_path, adb_connection_str, apk_path, aapt_path, sleep_time=5) -> bool:
