...
desired_caps = config()
appium_command = appium_driver(desired_caps, 'log/appiumlog.log', 'log/adblog.log', 'log/adberr.log', 10)
print(appium_command)
generate_test('log/adblog.log', appium_command, 'tests/tests.txt')
